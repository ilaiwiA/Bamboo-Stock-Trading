...
})({"lscq6":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "3a2658caeac66600";
"use strict";
...
},{}],"9Rvcn":[function(require,module,exports) {
// import * as model from "../model/model.js";
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _modelJs = require("../model/model.js");
var _stockListViewJs = require("../view/StockListView.js");
var _stockListViewJsDefault = parcelHelpers.interopDefault(_stockListViewJs);
var _purchaseViewJs = require("../view/PurchaseView.js");
var _purchaseViewJsDefault = parcelHelpers.interopDefault(_purchaseViewJs);
var _newsViewJs = require("../view/NewsView.js");
var _newsViewJsDefault = parcelHelpers.interopDefault(_newsViewJs);
var _stockDetailsViewJs = require("../view/StockDetailsView.js");
var _stockDetailsViewJsDefault = parcelHelpers.interopDefault(_stockDetailsViewJs);
var _portfolioChartViewJs = require("../view/PortfolioChartView.js");
var _portfolioChartViewJsDefault = parcelHelpers.interopDefault(_portfolioChartViewJs);
var _missingViewJs = require("../view/MissingView.js");
var _missingViewJsDefault = parcelHelpers.interopDefault(_missingViewJs);
var _userStockDetailsViewJs = require("../view/UserStockDetailsView.js");
var _userStockDetailsViewJsDefault = parcelHelpers.interopDefault(_userStockDetailsViewJs);
var _headerListViewJs = require("../view/HeaderListView.js");
var _headerListViewJsDefault = parcelHelpers.interopDefault(_headerListViewJs);
var _autoCompleteViewJs = require("../view/AutoCompleteView.js");
...
const controllerLoadPortfollio = async function() {
    try {
        ...
        if (id) return;
        (0, _portfolioChartViewJsDefault.default).renderLoad();
        (0, _stockListViewJsDefault.default).renderLoad();
        (0, _newsViewJsDefault.default).renderLoad();
        await _modelJs.loadUser();
        await _modelJs.loadPortfolio();
        await _modelJs.loadNews();
        (0, _portfolioChartViewJsDefault.default).clear();
        (0, _stockListViewJsDefault.default).clear();
        (0, _portfolioChartViewJsDefault.default).render(_modelJs.state);
        setInterval(async ()=>{
            if (_modelJs.state.stock.quotes.timePeriod != "day" || !(0, _helperJs.isMarketOpen)()) return;
            await _modelJs.updateStockQuotes("day");
            (0, _portfolioChartViewJsDefault.default).updateChart();
        }, (0, _configJs.CHART_UPDATE_INTERVAL));
        (0, _stockListViewJsDefault.default).render(_modelJs.state);
        if (_modelJs.state.stock.news) (0, _newsViewJsDefault.default).render(_modelJs.state);
...
const controllerChangePage = async function() {
    try {
        ...
        if (!ticker) return;
        await _modelJs.loadUser(ticker);
        (0, _portfolioChartViewJsDefault.default).renderLoad();
        (0, _purchaseViewJsDefault.default).renderLoad();
        (0, _newsViewJsDefault.default).renderLoad();
        window.scrollTo(0, 0);
        await _modelJs.loadWatchList();
        await _modelJs.loadStock(ticker);
        await _modelJs.loadStockSummary(ticker);
        await _modelJs.loadNews(ticker);
        (0, _portfolioChartViewJsDefault.default).clear();
        (0, _stockListViewJsDefault.default).clear();
        (0, _portfolioChartViewJsDefault.default).render(_modelJs.state);
        setInterval(async ()=>{
        ...
        (0, _purchaseViewJsDefault.default).render(_modelJs.state);
        (0, _userStockDetailsViewJsDefault.default).render(_modelJs.state);
        (0, _stockDetailsViewJsDefault.default).render(_modelJs.state);
        if (_modelJs.state.stock.news) (0, _newsViewJsDefault.default).render(_modelJs.state);
    } catch (error) {
        if (error.message === "Ticker not Found") {
            (0, _missingViewJsDefault.default).clear();
            (0, _missingViewJsDefault.default).render();
        } else {
            console.error(error);
            if (error.message === "401") {
                console.error(error);
...
const controllerPurchaseType = function(type, tradeType) {
    _modelJs.updatePurchaseType(type, tradeType);
    (0, _purchaseViewJsDefault.default).clear();
    (0, _purchaseViewJsDefault.default).render(_modelJs.state);
};
...
const controllerPurchaseSubmit = async function(orderBuyIn, orderValue, symbol, orderType) {
    await _modelJs.updateStock(orderBuyIn, orderValue.toString(), symbol, orderType);
    await _modelJs.updateUser();
    (0, _portfolioChartViewJsDefault.default).clear();
    (0, _purchaseViewJsDefault.default).clear();
    (0, _portfolioChartViewJsDefault.default).render(_modelJs.state);
    (0, _purchaseViewJsDefault.default).render(_modelJs.state);
...
const controller404Button = function() {
    try {
        (0, _missingViewJsDefault.default).renderStart();
    } catch (error) {
        console.error(error);
    }
};
const controllerWatchlist = function(ticker) {
    try {
        _modelJs.updateWatchlist(ticker);
        (0, _purchaseViewJsDefault.default).updateWatchlistIMG();
    } catch (error) {
        console.error(error);
    }
};
const controllerPortfolioDate = async function(date) {
    await _modelJs.updateStockQuotes(date);
    (0, _portfolioChartViewJsDefault.default).updateChart();
};
//Auth Controllers
...
const init = function() {
    (0, _portfolioChartViewJsDefault.default).addHandlerPortfolio(controllerLoadPortfollio);
    (0, _portfolioChartViewJsDefault.default).addHandlerPortfolio(controllerChangePage);
    (0, _portfolioChartViewJsDefault.default).addHandlerPortfolioDate(controllerPortfolioDate);
    (0, _purchaseViewJsDefault.default).addHandlerInput(controllerPurchaseType);
    (0, _purchaseViewJsDefault.default).addHandlerWatchlist(controllerWatchlist);
    (0, _purchaseViewJsDefault.default).addHandlerPurchaseForm(controllerPurchaseCancel);
    (0, _purchaseViewJsDefault.default).addHandlerSubmit(controllerPurchaseSubmit);
    // NewsView.addHandlerTicker(controllerChangePage);
    (0, _missingViewJsDefault.default).addHandlerHomeButton(controller404Button);
    (0, _headerListViewJsDefault.default).addHandlerLogout(controllerLogout);
};
init();

},{"../model/model.js":"9Ihpe","../view/StockListView.js":"59UDZ","../view/PurchaseView.js":"1GtQM","../view/NewsView.js":"f0ouk","../view/StockDetailsView.js":"4kLsc","../view/PortfolioChartView.js":"6505T","../view/MissingView.js":"6ivoe","../view/UserStockDetailsView.js":"hKbgE","../view/HeaderListView.js":"9QzG8","../view/AutoCompleteView.js":"hw0l1","../config.js":"4Wc5b","../helper.js":"6fitd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9Ihpe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "loadUser", ()=>loadUser);
parcelHelpers.export(exports, "loadPortfolio", ()=>loadPortfolio);
parcelHelpers.export(exports, "loadStockList", ()=>loadStockList);
parcelHelpers.export(exports, "loadWatchList", ()=>loadWatchList);
parcelHelpers.export(exports, "loadStock", ()=>loadStock);
parcelHelpers.export(exports, "updateStockQuotes", ()=>updateStockQuotes);
parcelHelpers.export(exports, "loadStockSummary", ()=>loadStockSummary);
parcelHelpers.export(exports, "loadNews", ()=>loadNews);
parcelHelpers.export(exports, "updatePurchaseType", ()=>updatePurchaseType);
parcelHelpers.export(exports, "updateWatchlist", ()=>updateWatchlist);
parcelHelpers.export(exports, "updateStock", ()=>updateStock);
...
//Generate Data
const generateStockList = function(data1) {
    try {
        const list = data1;
        list.forEach((a, i)=>{
            a.lastPrice = Number(a.lastPrice).toFixed(2);
            a.quantity = state.userStocks.find((val)=>val.ticker === a.symbol)?.quantity;
        });
        return list;
    } catch (error) {
        console.error(`${"\uD83D\uDEA8\uD83D\uDEA8\uD83D\uDEA8"} + ${error}`);
...
const generateStock = async function(ticker) {
    try {
        const data1 = await (0, _helperJs.getJSON)((0, _configJs.URL) + "stock/" + ticker);
        if (!data1) throw Error;
        return data1;
    } catch (error) {
        console.error(`${"\uD83D\uDEA8\uD83D\uDEA8\uD83D\uDEA8"} + ${error}`);
        window.location = "/";
...
const generateStockQuotes = async function(ticker, periodType = "day", sideChart = false) {
    try {
        const endpointURL = ticker === "portfolio" ? (0, _configJs.URL) + "user/portfolio/" + periodType : (0, _configJs.URL) + "stock/" + ticker + "/quotes/" + `${periodType === "day" ? "" : periodType}` + `${sideChart ? "reduced" : ""}`;
        const data1 = await (0, _helperJs.getJSON)(endpointURL);
        const timeStart = new Date();
        let dailyTimeData = [];
        let dailyPriceData = [];
        let isWeekday = periodType === "day" && timeStart.getDay() != 0 && timeStart.getDay() != 6 && timeStart.getHours() >= 6;
        if (timeStart.getDay() === 1 && timeStart.getHours() < 7 || new Date(data1[0].datetime).getDay() != timeStart.getDay()) isWeekday = false;
        if (isWeekday) {
            ...
            dailyTimeData = [
                ...new Array((0, _configJs.DAILY_5_MIN_INTERVAL))
            ].map((_, i)=>{
                return datetime + (0, _configJs.UNIX_MS_PER_5_MINUTE) * i;
            });
            const index = dailyTimeData.findIndex((a)=>a > currentTime.getTime());
            if (currentTime.getMinutes() % 5 != 0 && index != -1) dailyTimeData.splice(index, 0, currentTime.getTime());
            let x = 0;
            dailyPriceData = dailyTimeData.map((val, i, arr)=>{
                if (x === data1.length - 1 && val <= new Date().getTime()) {
                    const a = {
                        ...data1[x]
                    };
                    a.datetime = val;
                ...
                if (x > data1.length - 1) return;
                if (val < data1[x].datetime) {
                    const a = {
                        ...data1[x]
                    };
                    a.datetime = val;
                    if (arr[i + 1] >= data1[x + 1]?.datetime) x++;
                    return a;
                } else if (val === data1[x].datetime) {
                    const a = {
                        ...data1[x]
                    };
                    a.datetime = val;
        ...
        const stockPrices = dailyPriceData.length > 0 ? dailyPriceData : data1;
        const stockDates = dailyTimeData.length > 0 ? dailyTimeData : data1;
        const filteredDates = stockDates.map((a)=>{
            return new Intl.DateTimeFormat("en-US", periodType === "day" ? (0, _configJs.DAILY_PRICE_CONFIG) : periodType === "week" ? (0, _configJs.RECENT_PRICE_CONFIG) : (0, _configJs.PAST_PRICE_CONFIG)).format(a.datetime || a);
        });
        const dates = [
            ...filteredDates
        ];
        ...
        return {
            ...
            intraDates: dates.filter((_, i)=>i >= preMarket && i <= (postMarket === -1 ? dates.length - 1 : postMarket)),
            postDates: dates.filter((_, i)=>i > (postMarket === -1 ? dates.length - 1 : postMarket)),
            prices: stockPrices,
...
const generateStockSummary = function(data1) {
    try {
        Object.keys(data1).forEach((a, i)=>{
            data1[`${a[0].toLowerCase() + a.slice(1)}`] = data1[`${a}`];
            delete data1[`${a}`];
        });
        return data1;
    } catch (error) {
...
const generateNewsObject = function(data1, ticker) {
    try {
        if (!data1.feed) return;
        const filterSource = data1.feed.filter((a)=>a.source !== "Benzinga" || a.symbol.includes("CRYPTO") || a.symbol.includes("FOREX"));
        const filterSymbol = filterSource.filter((a)=>a.symbol === ticker);
        return filterSymbol.length > 1 ? generateNewsLimit(filterSymbol) : generateNewsLimit(filterSource);
    } catch (error) {
        console.error(error);
    }
};
const generateNewsLimit = function(data1) {
    const news = [];
    data1.forEach((a, i)=>{
        if (i >= (0, _configJs.NEWS_LIMIT)) return;
        news.push(a);
    });
    return news;
};
const loadUser = async function(ticker) {
    try {
        const { firstName, userName, portfolio: { stocks, watchList, stockList, availableBalance: availableBal, totalBalance } } = await (0, _helperJs.getJSON)((0, _configJs.URL) + "user");
        ...
        if (!ticker) {
            await loadStockList(watchList, (0, _configJs.WATCH_LIST));
            await loadStockList(stockList, (0, _configJs.USER_STOCK));
        }
        if (!watchList && stockList.length < 1 && !ticker) await loadStockList([
            "AAPL",
            "MSFT",
            "GOOGL",
            "AMZN",
...
const loadPortfolio = async function() {
    try {
        const data1 = await generateStockQuotes("portfolio", "day", false);
        state.stock = {};
        state.stock.symbol = "portfolio";
        state.stock.lastPrice = data1.prices[data1.prices.length - 1].close;
        state.stock.netChange = state.stock.lastPrice - data1.prices[0].previous;
        state.stock.netPercentChangeInDouble = (state.stock.lastPrice - data1.prices[0].previous) / data1.prices[0].previous * 100;
        state.stock.closePrice = data1.prices[0].previous;
        state.stock.quotes = data1;
        state.stock.quotes.timePeriod = "day";
    } catch (error) {
        console.error(error);
    }
};
const loadStockList = async function(stockList, panelType) {
    try {
        if (!stockList?.length) return delete state[`${panelType}`];
        const dataList = [
            ...Object.values(await (0, _helperJs.getJSON)((0, _configJs.URL) + "stocks/" + stockList))
        ];
        for (data of dataList)data.quotes = await generateStockQuotes(data.symbol, "day", true);
...
const loadWatchList = async function() {
    try {
        const data1 = await (0, _helperJs.getJSON)((0, _configJs.URL) + "user/" + `${0, _configJs.WATCH_LIST}`);
        if (!data1) return;
        state.watched = [
            ...Object.values(data1)
        ];
...
const loadStock = async function(ticker) {
    try {
        ...
        if (state.userStocks) state.stock.user = state?.userStocks.find((a)=>a.ticker === ticker);
        if (state.watched?.includes(ticker)) state.stock.bookmarked = true;
    } catch (error) {
        throw new Error("Ticker not Found");
    }
};
const updateStockQuotes = async function(date) {
    try {
        if (!state.stock) return;
        const ticker = state.stock.symbol === "portfolio" ? "portfolio" : state.stock.symbol;
...
const loadStockSummary = async function(ticker) {
    try {
        const data1 = await (0, _helperJs.getJSON)((0, _configJs.URL) + "stock/" + ticker + "/summary");
        const summary = generateStockSummary(data1);
...
const loadNews = async function(ticker) {
    try {
        let data1;
        if (ticker) data1 = await (0, _helperJs.getJSON)(`${(0, _configJs.URL)}${ticker}/news`);
        // !data.feed
        if (!ticker || data1.feed === null) data1 = await (0, _helperJs.getJSON)(`${(0, _configJs.URL)}news`);
        if (!data1) return;
        const news = generateNewsObject(data1, ticker);
        const stocks = news.map((a)=>{
            if (a.symbol.startsWith("FOREX") || !a.symbol) return "";
            return a.symbol;
        }).toString();
        const stockData = Object.values(await (0, _helperJs.getJSON)((0, _configJs.URL) + "stocks/" + stocks)).map((a, i, arr)=>{
            return a.symbol ? {
                symbol: a.symbol,
...
const updatePurchaseType = function(type, tradeType) {
    try {
...
const updateWatchlist = async function(ticker) {
    try {
        /*
    ...
    */ const res = await (0, _helperJs.postJSON)((0, _configJs.URL) + "user/portfolio/watchlist", {
            ticker
        });
    } catch (error) {
        console.error(error);
...
const updateStock = async function(orderBuyIn, orderValue, symbol, orderType) {
    try {
        const status = orderType === "buy" ? await (0, _helperJs.postJSON)((0, _configJs.URL) + "user/purchase", {
            orderBuyIn,
            orderValue,
            symbol
        }) : await (0, _helperJs.postJSON)((0, _configJs.URL) + "user/sell", {
            orderBuyIn,
            orderValue,
            symbol
        });
        if (await status.text() === "all shares sold") delete state.stock.tradeType;
    } catch (error) {
        console.error(error);
    }
};
const updateUser = async function() {
    try {
        const { firstName, userName, portfolio: { stocks, availableBalance: availableBal } } = await (0, _helperJs.getJSON)((0, _configJs.URL) + "user");
        state["firstName"] = firstName;
        state["userName"] = userName;
        state[`availableBal`] = availableBal;
        state["userStocks"] = stocks;
...
const logout = async function() {
    try {
        const response = await (0, _helperJs.getJSON)((0, _configJs.URL_AUTH) + "logout");
        if (response.response === "success") window.location.href = "/Bamboo-Stock-Trading/LoginPage.html";
    } catch (error) {
        throw error;
    }
};

},{"../config.js":"4Wc5b","../helper.js":"6fitd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4Wc5b":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TIME_OUT", ()=>TIME_OUT);
parcelHelpers.export(exports, "URL", ()=>URL);
parcelHelpers.export(exports, "URL_AUTH", ()=>URL_AUTH);
parcelHelpers.export(exports, "USER_STOCK", ()=>USER_STOCK);
parcelHelpers.export(exports, "WATCH_LIST", ()=>WATCH_LIST);
parcelHelpers.export(exports, "TOP_LIST", ()=>TOP_LIST);
parcelHelpers.export(exports, "NEWS_LIMIT", ()=>NEWS_LIMIT);
parcelHelpers.export(exports, "DAILY_1_MIN_INTERVAL", ()=>DAILY_1_MIN_INTERVAL);
parcelHelpers.export(exports, "DAILY_5_MIN_INTERVAL", ()=>DAILY_5_MIN_INTERVAL);
parcelHelpers.export(exports, "DAILY_15_MIN_INTERVAL", ()=>DAILY_15_MIN_INTERVAL);
parcelHelpers.export(exports, "UNIX_MS_PER_MINUTE", ()=>UNIX_MS_PER_MINUTE);
parcelHelpers.export(exports, "UNIX_MS_PER_5_MINUTE", ()=>UNIX_MS_PER_5_MINUTE);
parcelHelpers.export(exports, "UNIX_MS_PER_15_MINUTE", ()=>UNIX_MS_PER_15_MINUTE);
parcelHelpers.export(exports, "CHART_UPDATE_INTERVAL", ()=>CHART_UPDATE_INTERVAL);
parcelHelpers.export(exports, "DAILY_PRICE_CONFIG", ()=>DAILY_PRICE_CONFIG);
parcelHelpers.export(exports, "RECENT_PRICE_CONFIG", ()=>RECENT_PRICE_CONFIG);
parcelHelpers.export(exports, "DISPLAY_PRICE_CONFIG", ()=>DISPLAY_PRICE_CONFIG);
parcelHelpers.export(exports, "PAST_PRICE_CONFIG", ()=>PAST_PRICE_CONFIG);
parcelHelpers.export(exports, "tickers", ()=>tickers);
// import tickerList from "url:/images/tickers_noSpecialChart.csv"; //prevents chrome due to CORS
var _tickersNoSpecialChartWithNameCsv = require("url:/images/tickers_noSpecialChart_withName.csv"); //prevents chrome due to CORS
var _tickersNoSpecialChartWithNameCsvDefault = parcelHelpers.interopDefault(_tickersNoSpecialChartWithNameCsv);
const TIME_OUT = 10;
const URL = "https://bamboospring-production.up.railway.app/api/"; // prod server
const URL_AUTH = "https://bamboospring-production.up.railway.app/auth/";
const USER_STOCK = "stocklist";
const WATCH_LIST = "watchlist";
const TOP_LIST = "toplist";
const NEWS_LIMIT = 10;
const DAILY_1_MIN_INTERVAL = 780; // 5pm to 7pm at 1 min interval
const DAILY_5_MIN_INTERVAL = 156; // 5pm to 7pm at 5 min interval
const DAILY_15_MIN_INTERVAL = 52; // 5pm to 7pm at 15 min interval
const UNIX_MS_PER_MINUTE = 60000;
const UNIX_MS_PER_5_MINUTE = 300000;
const UNIX_MS_PER_15_MINUTE = 900000;
const CHART_UPDATE_INTERVAL = 7500;
const DAILY_PRICE_CONFIG = {
    hour: "numeric",
    minute: "numeric"
};
const RECENT_PRICE_CONFIG = {
    month: "short",
    day: "numeric",
    hour: "numeric",
    minute: "numeric"
};
const DISPLAY_PRICE_CONFIG = {
    month: "short",
    day: "numeric",
    year: "numeric",
    hour: "numeric",
...
const tickers = fetch((0, _tickersNoSpecialChartWithNameCsvDefault.default)).then((a)=>a.text()).then((a)=>a.split("\n").map((a)=>{
        const tickerArr = a.split(",");
        tickerArr[1] = tickerArr[1]?.slice(0, -1);
        if (tickerArr[1] === "undefined" || !tickerArr[1] || tickerArr[1].length < 1 || tickerArr[0] === "ZZZ") return;
        return tickerArr;
    }).filter((a)=>a));

},{"url:/images/tickers_noSpecialChart_withName.csv":"6whyg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6whyg":[function(require,module,exports) {
module.exports = require("291eb94c5ecc658e").getBundleURL("4ZwRf") + "tickers_noSpecialChart_withName.c5c6cc61.csv" + "?" + Date.now();

},{"291eb94c5ecc658e":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
parcelHelpers.export(exports, "isMarketOpen", ()=>isMarketOpen);
var _configJs = require("./config.js");
...
},{"./config.js":"4Wc5b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"59UDZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
(0, _auto.Chart).register((0, _chartjsPluginAnnotationDefault.default));
class StockListView extends (0, _viewJsDefault.default) {
    ...
    addHandlerRender(handler) {
        [
            "load"
        ].forEach((a)=>window.addEventListener(a, function() {
                handler();
            }));
    }
    _generateHTML = function() {
        return `${this._generatePanelTypes().map(this._generatePanel.bind(this)).join("")}`;
    };
    _generatePanel = function(panelType) {
        ...
        <div class="side-container ${panelType}">
          ...
          ${this._user[`${panelType}`].map(this._generateStocks.bind(this)).join("")}
          </div>
        </div>
        `;
    };
    _generatePanelType = function(panelType) {
        switch(panelType){
            case 0, _configJs.WATCH_LIST:
                return "Watchlist";
            case 0, _configJs.USER_STOCK:
                return "My Stocks";
            case 0, _configJs.TOP_LIST:
                return "Top Stocks";
        }
    };
    ...
    <a class="stocks" id = "${data.symbol}" href="#stocks/${data.symbol}">
        <div class="ticker">
            <p>${data.symbol}</p>
            ${data.quantity ? `<p class= "ticker-sub user-shares">${data.quantity} ${data.quantity > 1 ? "Shares" : "Share"}` : ""}
        </div>
        ...
        <p>${data.lastPrice}<p>
        <p class= "ticker-sub ${this._generateColor(data.netPercentChangeInDouble)}">${Number(data.netPercentChangeInDouble).toFixed(2)}%<p>
        </div>    
    </a>
    `;
    };
    ...
    createChart(panelType) {
        ...
        const tickers = this._parentElement.querySelector(`.${panelType}`).querySelector(".stocks-panel");
        for(let i = 0; i < tickers.children.length; i++){
            ...
            new (0, _auto.Chart)(tickers.children[i].querySelector("canvas"), {
                type: "line",
                data: {
                    labels: this._user[`${panelType}`][i].quotes.dates,
                    datasets: [
                        {
                            data: this._user[`${panelType}`][i].quotes.prices.map((a)=>a.close)
                        }
                    ]
                },
                options: {
...
exports.default = new StockListView();

},{"chart.js/auto":"d8NN9","chartjs-plugin-annotation":"5xmc5","../config.js":"4Wc5b","./View.js":"63su2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5xmc5":[function(require,module,exports) {
/*!
...
},{"./chunks/helpers.segment.js":"7oQuk","@kurkle/color":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"63su2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../config.js");
class View {
    render(data) {
        if (!data) return;
        this._user = data;
        this._currentStock = data?.userStocks.find((a)=>a.ticker === data.stock.symbol);
    ...
    _generatePanelTypes() {
        return [
            this._user.stocklist ? (0, _configJs.USER_STOCK) : undefined,
            this._user.watchlist ? (0, _configJs.WATCH_LIST) : undefined,
            this._user.toplist ? (0, _configJs.TOP_LIST) : undefined
        ].filter((a)=>a);
    }
    _generateColor(data) {
...
},{"../config.js":"4Wc5b","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1GtQM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _checkmarkSvg = require("url:/images/checkmark.svg");
var _checkmarkSvgDefault = parcelHelpers.interopDefault(_checkmarkSvg);
var _plusSignSvg = require("url:/images/plus-sign.svg");
var _plusSignSvgDefault = parcelHelpers.interopDefault(_plusSignSvg);
class PurchaseView extends (0, _viewJsDefault.default) {
    _parentElement = document.querySelector(".aside-container");
    constructor(){
        super();
    ...
    addHandlerReview() {
        this._parentElement.addEventListener("submit", this.reviewPurchase.bind(this));
    }
    addHandlerPurchaseForm(handler) {
        ...
        this._parentElement.addEventListener("click", function(e) {
            ...
            if (e.target.closest(".purchase-panel-header")?.children.length > 1) {
                ...
                e.target.style = `border-bottom: 1px solid var(--${a._generateColor(a._data.netChange)})`;
                e.target.classList.toggle("active");
                const siblingElement = id === "buy" ? e.target.nextElementSibling : e.target.previousElementSibling;
    ...
    reviewPurchase(e) {
        e.preventDefault();
        const orderType = e.target.closest(".purchase-panel").querySelector(".active").id;
        ...
        const orderEstCost = e.target.querySelector("#estimated-price").innerHTML.slice(1).replace(",", "");
        if (button.value.toLowerCase() === "submit") return this._submitHandler(orderBuyIn, orderValue, this._data.symbol, orderType);
        const parameterSuccess = [
            buttonContainer,
            this._generateReviewMessageSuccess(orderBuyIn, orderValue, this._data.lastPrice, type),
            this._generateCancelButton(this._data.netChange)
        ];
        const parameterFailure = [
            buttonContainer,
            this._generateReviewMessageFailure(orderBuyIn, orderBuyIn === "Share" ? orderEstCost : orderValue),
            this._generateCancelButton(this._data.netChange),
            false
        ];
        if (orderType === "buy") this._checkValidPurchase(orderBuyIn, orderValue) ? this.renderPurchaseReview.call(...parameterSuccess) : this.renderPurchaseReview.call(...parameterFailure);
        else if (orderType === "sell") this._checkValidSell(orderBuyIn, orderValue) ? this.renderPurchaseReview.call(...parameterSuccess) : this.renderPurchaseReview.call(...parameterFailure);
    }
    addHandlerInput(handler) {
        this._parentElement.addEventListener("input", this.updatePurchasePanel.bind(handler));
    }
    renderPurchaseReview(html, buttonHtml, success = true) {
        ...
        success ? this.querySelector(".btn-submit").value = "Submit" : this.querySelector(".btn-submit").remove();
    ...
    updatePurchasePanel(e) {
        ...
        if (e.target.id === "order-type") {
            const purchaseID = e.target.closest(".purchase-panel").querySelector(".active").id;
        ...
        if (e.target.id === "order-Shares") {
            const cost = Number(val * +parent.querySelector("#market-price").innerHTML.slice(1)).toFixed(2);
            html.innerHTML = "$" + Intl.NumberFormat("en-US", {
                minimumFractionDigits: 2
            }).format(cost);
        } else if (e.target.id === "order-Dollars") {
            const cost = val / +parent.querySelector("#market-price").innerHTML.slice(1);
    ...
    updateWatchlistIMG() {
        ...
        if (img.src.includes("plus")) img.src = (0, _checkmarkSvgDefault.default);
        else img.src = (0, _plusSignSvgDefault.default);
    }
    _generateHTML() {
        return `
          ...
          ${this._generateHeaderHTML()}
            ...
            <form action="" class="purchase-form">
              ...
              <section>
                ...
                <input type="number" min="0" class= "order-value" step="0.01" id="order-${this._generatePurchaseType(this._data.purchaseType)}" placeholder = '0'/>
              </section>
              
              <section class="current-market">
                <p>Market Price</p>
                <p id="market-price">$${Number(this._data.lastPrice).toFixed(2)}</p>
              </section>
              <hr />

              <section class="current-estimated">
                <p>${this._data.purchaseType === "Dollars" ? "Est. Quantity" : "Est. Price"}</p>
                <p id="estimated-price">${this._data.purchaseType === "Dollars" ? "" : "$"}0.00
                </p>
              </section>


              <div class="form-buttons">
                <input type="submit" class="btn-submit btn-alternative" value="Review" style="background-color: var(--${this._generateColor(`${this._data.netChange}`)}" />
              </div>
            </form>
    ...
    _generateHeaderHTML() {
        const activeClass = `class = "active" style= "border-bottom: 1px solid var(--${this._generateColor(this._data.netChange)})"`;
        return `
    <section class="purchase-panel-header">
    <h2 id="buy" ${!this._data.tradeType || !this._currentStock || this._data.tradeType === "buy" ? activeClass : ""}>Buy ${this._data.symbol}</h2>
    ${this._currentStock ? `<h2 id="sell" ${this._data.tradeType === "sell" ? activeClass : ""}>Sell ${this._data.symbol}</h2>` : ""}
  </section>
    `;
    }
    ...
    <select name="order-type" id="order-type">
      <option value="Shares" ${data === "Shares" ? "selected" : ""}>Shares</option>
      <option value="Dollars" ${data === "Dollars" ? "selected" : ""}>Dollars</option>
    </select>
    `;
    }
    ...
    _generateSubLabelHTML() {
        return `
    <button class="btn-alternative ${this._generateColor(this._data.netChange)}_button btn-subPanel" id= 'btn_watchlist'>
    <img
      class="${this._generateColor(this._data.netChange)}_symbol"
      src="${this._data.bookmarked ? (0, _checkmarkSvgDefault.default) : (0, _plusSignSvgDefault.default)}"
      alt=""
    />
    Add to Watchlist
    </button>
    ...
    _generateAvailableBal() {
        if (!this._currentStock || !this._data.tradeType || this._data.tradeType === "buy") return `${this._formatCurrency(+this._user.availableBal)} available`;
        if (!this._data.purchaseType || this._data.purchaseType === "Shares") return `${this._currentStock.quantity} ${this._currentStock.ticker} available`;
        else return `${this._formatCurrency(+this._currentStock.quantity * +this._data.lastPrice)} available`;
    }
    ...
    <h3>Order Summary </h3>
    ${orderBuyIn === "Shares" ? `You are placing a market order to ${type} ${quantity} ${quantity === 1 ? "share" : "shares"} of ${this._data.symbol}. Your pending order will execute at ${price} per share or better.` : `You are placing a market order to ${type} ${quantity} ${quantity === 1 ? "dollar" : "dollars"} of ${this._data.symbol}. 
    Your pending order will execute at the best market price.`}</section>`;
    }
    _generateReviewMessageFailure(orderBuyIn, failureRes) {
        return `
    <section class="order-summary">
    <h3>${failureRes <= 0 ? "Order not valid." : "Not enough buying power"} </h3>

    ${failureRes <= 0 ? `Your order must be greater than 0 ${orderBuyIn === "Shares" ? "shares" : "dollars"}.` : "You do not have enough buying power in your account to place this order."}
    </section>
    `;
    }
    ...
    _checkValidPurchase(type, orderValue) {
        if (type === "Shares") return orderValue * this._data.lastPrice <= this._user.availableBal && orderValue > 0;
        else if (type === "Dollars") return orderValue <= this._user.availableBal;
    }
    _checkValidSell(type, orderValue) {
        const ticker = this._user.userStocks.find((a)=>a.ticker === this._data.symbol);
        if (type === "Shares") return orderValue <= ticker.quantity;
        else if (type === "Dollars") return orderValue / this._data.lastPrice <= ticker.quantity;
    }
}
exports.default = new PurchaseView();

},{"./View.js":"63su2","url:/images/checkmark.svg":"6fVK7","url:/images/plus-sign.svg":"1udv9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6fVK7":[function(require,module,exports) {
module.exports = require("ac49c564fde62476").getBundleURL("4ZwRf") + "checkmark.556137ae.svg" + "?" + Date.now();

},{"ac49c564fde62476":"lgJ39"}],"1udv9":[function(require,module,exports) {
module.exports = require("7254f7ffe6dad5e1").getBundleURL("4ZwRf") + "plus-sign.b2bb7978.svg" + "?" + Date.now();

},{"7254f7ffe6dad5e1":"lgJ39"}],"f0ouk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
var _stockImgJpg = require("url:/images/stock_img.jpg");
var _stockImgJpgDefault = parcelHelpers.interopDefault(_stockImgJpg);
class NewsView extends (0, _viewJsDefault.default) {
    ...
    addHandlerTicker() {
        this._parentElement.addEventListener("click", function(e) {
            ...
            e.preventDefault();
            const id = e.target.closest(".news-tickers")?.querySelector(".news-ticker").innerHTML;
    ...
    ${data.source}
    <span class="news-publisher-time">${this._calcDate(data.time_published)}</span>
    </p>
    <h1 class="news-title">
    ${data.title}
    </h1>
    ...
    <div class="news-tickers">
      ...
      <span class="${this._generateColor(+data.netChange)}">${+data.netPercentChangeInDouble ? Number(+data.netPercentChangeInDouble).toFixed(2) + "%" : ""}</span>
    </div>
    ` : ""}
        ...
        <div class = "news-image">
            <img
            src="${data.banner_image || (0, _stockImgJpgDefault.default)}"
            alt=""
            />
      </div>
  </a>  
  `;
    ...
    _calcDate(data) {
        ...
        const dayDiff = Math.abs(this._convertToDays(today) - this._convertToDays(date));
        if (dayDiff < 31) return `${dayDiff}d`;
        return `${Math.trunc(dayDiff / 31) === 1 ? `1 Month Ago` : `${Math.trunc(dayDiff / 31)} months ago`}`;
    }
    _convertTime(time) {
        const timeSplit = time.split("T");
        timeSplit[0] = timeSplit[0].slice(0, 4) + "-" + timeSplit[0].slice(4, 6) + "-" + timeSplit[0].slice(6);
        timeSplit[1] = timeSplit[1].slice(0, 2) + ":" + timeSplit[1].slice(2, 4) + ":" + timeSplit[1].slice(4) + "Z";
...
},{"./View.js":"63su2","url:/images/stock_img.jpg":"iEaRh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iEaRh":[function(require,module,exports) {
module.exports = require("741cb63976de6c65").getBundleURL("4ZwRf") + "stock_img.7cf6bb0d.jpg" + "?" + Date.now();

},{"741cb63976de6c65":"lgJ39"}],"4kLsc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class StockDetailsView extends (0, _viewJsDefault.default) {
    _parentElement = document.querySelector(".main-container");
    _generateHTML() {
        return this._generateAboutSection() + this._generateStatisticsSection();
    }
    _generateAboutSection() {
        if (!this._data.summary || this._data.summary.description === "None") return "";
        return `
        <section>
          <h1>About</h1>
          <div class="sub-panel">
        ...
        <section>
          ...
          <div class="sub-panel">
            <ul>
              <li>
                <p><b>Market cap</b></p>
                <p>${Number.isFinite(this._data.summary?.marketCapitalization) ? Intl.NumberFormat("en-US", {
            notation: "compact",
            maximumFractionDigits: 2
              ...
              <li>
                <p><b>Volume</b></p>
                <p>${Number.isFinite(this._data.totalVolume) ? Intl.NumberFormat("en-US", {
            notation: "compact",
            maximumFractionDigits: 2
...
exports.default = new StockDetailsView();

},{"./View.js":"63su2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6505T":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _auto = require("chart.js/auto");
var _chartjsPluginAnnotation = require("chartjs-plugin-annotation");
...
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
(0, _auto.Chart).register((0, _chartjsPluginAnnotationDefault.default));
class PortfolioChartView extends (0, _viewJsDefault.default) {
    _parentElement = document.querySelector(".main-container");
    constructor(){
        super();
    }
    ...
    addHandlerPortfolioDate(handler) {
        this._parentElement.addEventListener("click", function(e) {
            if (e.target.closest(".portfolio-dates") && e.target.id !== "") handler(e.target.id);
        });
    }
    _generateHTML() {
        return `
    <div class="portfolio-container">
        ...
        <div class="sub-panel" id="buying-power">
          <div class="portfolio-bp">
            <p>Buying Power</p>
            <p id="available-bal">${this._formatCurrency(this._user.availableBal || "0.00")}</p>
         </div>
        </div>
        ` : ""}
        `;
    ...
    _generatePriceHTML() {
        const title = this._data.summary?.name ? this._data.summary.name.indexOf("Inc") != -1 ? this._data.summary.name.slice(0, this._data.summary.name.indexOf("Inc")) : this._data.summary.name : -1;
        return `
    <div class="chart-info">
    ${title != -1 ? `<h1>${title}</h1>` : `<h1>${this._data.symbol === "portfolio" ? "" : this._data.symbol || ""}</h1>`}
      <h1 class="ticker-price">${this._formatCurrency(+this._data.lastPrice)}</h1>
      <span class="${this._generateColor(+this._data.netChange)} ticker-change">${this._generateSymbol(+this._data.netChange)}${Number(this._data.netChange).toFixed(2)} 
        
        <span>(${this._data.netPercentChangeInDouble.toFixed(2)}${this._data.netPercentChangeInDouble === 0 ? "" : "%"})</span>
      </span>
        
      <span class="ticker-date">${this._generateDate(this._data.quotes?.timePeriod) || ""}</span>
    </div>
    `;
    }
    updateChart() {
        const rgb = this._generateRGB(this._data.quotes.timePeriod === "day" ? this._data.netChange : this._data.quotes.prices.slice(-1)[0].close - this._data.quotes.prices[0].close);
        const dailyLine = this._data.quotes.timePeriod === "day" ? {
            type: "line",
        ...
        const max = Math.max.apply(this, this._data.quotes.prices.map((a)=>a.close));
        const min = Math.min.apply(this, this._data.quotes.prices.map((a)=>a.close));
        this.myChart.data.labels = this._data.quotes.dates;
        this.myChart.data.datasets[0].data = this._data.quotes.prices.map((a)=>a.close);
        this.myChart.options.plugins.annotation.annotations.line1 = dailyLine;
        this.myChart.options.borderColor = rgb;
        this.myChart.options.scales.y.max = max - min !== 0 ? max + (max - min) / 5 : undefined;
        const recentLivePrice = this.myChart.data.datasets[0].data.slice(-1)[0];
        const recentPreviousPrice = this._data.symbol === "portfolio" ? this._data.closePrice : +recentLivePrice - +this._data.netChange;
        this._updatePrice(+recentLivePrice, this._data.quotes.timePeriod === "day" ? recentPreviousPrice : +this._data.quotes.prices[0].close);
        this.myChart.update();
    }
    _generateChart() {
        const mainChart = document.querySelector("#portfolio-chart");
        const rgb = this._generateRGB(this._data.quotes.timePeriod === "day" ? this._data.netChange // default
         : this._data.quotes.prices.slice(-1)[0].close - this._data.quotes.prices[0].close);
        const dailyLine = this._data.quotes.timePeriod === "day" ? {
            type: "line",
            yMax: this._data.closePrice,
            yMin: this._data.closePrice,
        ...
        (0, _auto.Tooltip).positioners.top = function(elements, eventPosition) {
            const { chartArea: { top }, scales: { x } } = this.chart;
            ...
            return {
                x: xIndexData ? x.getPixelForValue(xIndex) : x.getPixelForValue(dataIndex - 1),
                y: top
            };
        };
        const min = Math.min.apply(null, this._data.quotes.prices.map((a)=>a.close));
        let max = Math.max.apply(null, this._data.quotes.prices.map((a)=>a.close));
        if (this._data.quotes.timePeriod === "day" && this._data.closePrice > max) max = this._data.closePrice;
        this.myChart = new (0, _auto.Chart)(mainChart, {
            type: "line",
            data: {
    ...
    _updatePrice(currentPrice, previousPrice) {
        ...
        const netChangePercent = ((currentPrice - previousPrice) / previousPrice * 100).toFixed(2);
        // tickerPrice.innerHTML = "$" + currentPrice.toFixed(2);
        tickerPrice.innerHTML = this._formatCurrency(currentPrice);
        tickerNetChange.classList.replace(netChangeColor, this._generateColor(netChangePercent));
        tickerNetChange.textContent = `${this._generateSymbol(netChange)}${netChange} (${netChangePercent}%)`;
    ...
    _onHover(e, active, chart) {
        ...
        if (this._data.quotes.timePeriod === "day") {
            ...
            if (this._data.quotes.preDates.includes(currentLabel)) currentSection = "preDates";
            else if (this._data.quotes.intraDates.includes(currentLabel)) currentSection = "intraDates";
            else currentSection = "postDates";
            chart.data.datasets[0].segment = {
                borderColor: (ctx)=>{
                    return this._data.quotes[`${currentSection}`].includes(chart.data.labels[ctx.p0DataIndex]) ? rgb : undefined;
                }
            };
        }
        ...
        if (this._data.quotes.timePeriod === "day") this._updatePrice(+currentPrice.toFixed(2), +this._data.closePrice);
        else this._updatePrice(+currentPrice.toFixed(2), +this._data.quotes.prices[0].close);
        chart.update();
    }
    _onMouseOut(chart, args, options) {
        ...
        if (event.type === "mouseout") {
            ...
            this._updatePrice(+this._data.lastPrice, this._data.quotes.timePeriod === "day" ? +this._data.lastPrice - +this._data.netChange : +this._data.quotes.prices[0].close);
            chart.update();
        }
    }
}
exports.default = new PortfolioChartView();

},{"chart.js/auto":"d8NN9","chartjs-plugin-annotation":"5xmc5","./View.js":"63su2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6ivoe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class MissingView extends (0, _viewJsDefault.default) {
...
exports.default = new MissingView();

},{"./View.js":"63su2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hKbgE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../config.js");
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class UserStockDetailsView extends (0, _viewJsDefault.default) {
    _parentElement = document.querySelector(".main-container");
    _generateHTML() {
    ...
    <div class="user-stock-panel equity-panel">
        <div class="user-stock-info">
            <h4>Your Equity</h4>
            <h1>${this._formatCurrency(this._data.lastPrice * this._currentStock.quantity)}</h1>
        </div>
    ...
    <div class="user-stock-panel cost-panel">
        ...
        <div class="user-stock-stats">
            <p>Date purchased</p>
            <p>${new Intl.DateTimeFormat("en-US", (0, _configJs.DISPLAY_PRICE_CONFIG)).format(this._currentStock.date)}</p>
        </div>
        <hr/>
    ...
    _generateTotalReturnHTML() {
        const returnDollars = (this._data.lastPrice - this._currentStock.avgPrice) * this._currentStock.quantity;
        const totalReturnDollars = this._formatCurrency(returnDollars);
        const totalReturnPercentage = (this._data.lastPrice - this._currentStock.avgPrice) / this._data.lastPrice * 100;
        return `${this._generateSymbol(returnDollars)}${totalReturnDollars} (${totalReturnPercentage.toFixed(2)}%)`;
    }
    _generateTodayReturnHTML() {
        ...
        if (new Date().getFullYear() === new Date(this._currentStock.date).getFullYear() && new Date().getMonth() === new Date(this._currentStock.date).getMonth() && new Date().getDate() === new Date(this._currentStock.date).getDate()) return this._generateTotalReturnHTML();
        return `${this._generateSymbol(returnDollars)}${todayReturnDollars} (${todayReturnPercentage.toFixed(2)}%)`;
    }
}
exports.default = new UserStockDetailsView();

},{"../config.js":"4Wc5b","./View.js":"63su2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9QzG8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class HeaderListView extends (0, _viewJsDefault.default) {
...
exports.default = new HeaderListView();

},{"./View.js":"63su2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hw0l1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _configJs = require("../config.js");
var _viewJs = require("./View.js");
var _viewJsDefault = parcelHelpers.interopDefault(_viewJs);
class AutoCompleteView extends (0, _viewJsDefault.default) {
    ...
    addSearchHandler() {
        [
            "input"
        ].forEach((action)=>this.searchBar.addEventListener(action, this.autoComplete.bind(this)));
    }
    addResultsHandler() {
    ...
    async autoComplete(e) {
        ...
        if (userInput.length > 1) {
            ...
            if (results.length === 0) {
                this.resultsHTML.innerHTML = "<li>We were unable to find any results for your search.</li>";
                return;
            }
            const resultsLength = results.length >= 10 ? 10 : results.length;
            for(let i = 0; i < resultsLength; i++)this.resultsHTML.innerHTML += `<li class='auto-ticker' id='${results[i][0]}'><p>${results[i][1]}</p> <p>${results[i][0]}</p></li>`;
        }
    }
    async getSearchResults(userInput) {
        const results = [];
        const data = await (0, _configJs.tickers);
        let tickerBool = false;
        for(let i = 0; i < data.length; i++)if (userInput === data[i][1]?.slice(0, userInput.length).toUpperCase()) {
            results.push(data[i]);
            tickerBool = true;
        }
        return results;
...
},{"../config.js":"4Wc5b","./View.js":"63su2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lscq6","9Rvcn"], "9Rvcn", "parcelRequire10c2")

//# sourceMappingURL=index.eac66600.js.map
